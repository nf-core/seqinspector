...
Hi there!
Thanks for taking an interest in improving nf-core/seqinspector.

This page describes the recommended nf-core way to contribute to both nf-core/seqinspector and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of nf-core/seqinspector.

> [!NOTE]
> If you need help using or modifying nf-core/seqinspector, ask on the nf-core Slack [#seqinspector](https://nfcore.slack.com/channels/seqinspector) channel ([join our Slack here](https://nf-co.re/join/slack)).
...
- [ ] Check whether a GitHub [issue](https://github.com/nf-core/seqinspector/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [nf-core/seqinspector repository](https://github.com/nf-core/seqinspector) to your GitHub account.
...
For further information and help, see the [nf-core/seqinspector documentation](https://nf-co.re/seqinspector/usage) or ask on the nf-core [#seqinspector](https://nfcore.slack.com/channels/seqinspector) Slack channel ([join our Slack here](https://nf-co.re/join/slack)).

### GitHub Codespaces

You can contribute to nf-core/seqinspector without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/nf-core/seqinspector/codespaces).
...
nf-core semi-standardises how you write code and other contributions to make the nf-core/seqinspector code and processing logic more understandable for new contributors and to ensure quality.
