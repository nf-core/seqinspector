...
| `QC`                       | [`Riker`](https://github.com/fulcrumgenomics/riker)                                                                 | Collect BAM-level QC metrics (alignment, base distribution, insert size, GC bias, WGS, error metrics). | [DNA]                   | [BWA-MEM2, SAMtools, `--fasta`]                                                          | no           |
