...
def toolCitationMap() {
    return [
        ...
        'seqkit': 'SeqKit (<a href="https://doi.org/10.1371/journal.pone.0163962">DOI:10.1371/journal.pone.0163962</a>)',
...
def toolBibliographyMap() {
    return [
        ...
        'fq': '<li>FQ: Command line utility for filtering, subsampling, and validating FASTQ files. URL: <a href="https://github.com/stjude-rust-labs/fq">https://github.com/stjude-rust-labs/fq</a>.</li>',
