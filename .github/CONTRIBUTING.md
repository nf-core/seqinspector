...
We try to manage the required tasks for nf-core/seqinspector using GitHub issues, you probably came to this page when creating one.
...
> [!NOTE]
> If you need help using or modifying nf-core/seqinspector then the best place to ask is on the nf-core Slack [#seqinspector](https://nfcore.slack.com/channels/seqinspector) channel ([join our Slack here](https://nf-co.re/join/slack)).

## Contribution workflow

If you'd like to write some code for nf-core/seqinspector, the standard workflow is as follows:
...
- Open the repo in [Codespaces](https://github.com/nf-core/seqinspector/codespaces)
- Tools installed
  - nf-core
  - Nextflow
